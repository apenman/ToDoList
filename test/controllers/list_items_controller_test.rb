...
class ListItemsControllerTest < ActionController::TestCase
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post :create, list_item: { description: @list_item.description, list_id: @list_item.list_id, task: @list_item.task }
    end
  ...
  test "should update list_item" do
    patch :update, id: @list_item, list_item: { description: @list_item.description, list_id: @list_item.list_id, task: @list_item.task }
    assert_redirected_to list_item_path(assigns(:list_item))
  end
